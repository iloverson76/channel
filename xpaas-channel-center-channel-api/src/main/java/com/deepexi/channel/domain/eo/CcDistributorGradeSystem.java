...
* @author admin
*/
//@ApiModel(description = "等级体系表")
public class CcDistributorGradeSystem{

// @ApiModelProperty(value = "ID")
    @TableId
    @TableField(value = "`id`")
    private Integer  id;
// @ApiModelProperty(value = "等级体系名称")
    @TableField(value = "`grade_system_name`")
    private String gradeSystemName;
// @ApiModelProperty(value = "等级体系编码")
    @TableField(value = "`grade_system_code`")
...
// @ApiModelProperty(value = "租户id")
    ...
    public void setGradeSystemCode(String gradeSystemCode){
    this.gradeSystemCode = gradeSystemCode;
    }

    public String getGradeSystemCode(){
