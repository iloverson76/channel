...
public class ChainController {
    ...
    public Payload<Boolean> update(@Valid @PathVariable(value = "id", required = true) Long id, @RequestBody ChainDetailVO vo) {
        if(vo == null){
    ...
    public Payload<Boolean> create(@Valid @RequestBody ChainDetailVO chainDetailVO) {
