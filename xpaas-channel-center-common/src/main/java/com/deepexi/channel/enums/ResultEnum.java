...
public enum ResultEnum implements BaseEnumType {
    ...
    PARENT_ILLEGAL("400","父级节点设置不合法，该父级节点已被其他节点设置为父级节点或者被限制上级了"),
    AREA_CODE_DUPLICATED("400","区域编码不能重复"),
    AREA_NAME_DUPLICATED("400","区域中文名称不能重复"),
    AREA_NAME_EN_DUPLICATED("400","区域英文名称不能重复"),
    AREA_TYPE_CODE_DUPLICATED("400","区域类型编码不能重复"),
    AREA_TYPE_NAME_DUPLICATED("400","区域类型中文名称不能重复"),
    AREA_TYPE_NAME_EN_DUPLICATED("400","区域类型英文名称不能重复"),
    DISTRIBUTOR_CODE_DUPLICATED("400","经销商编码不能重复"),
    DISTRIBUTOR_NAME_DUPLICATED("400","经销商中文名称不能重复"),
    DISTRIBUTOR_NAME_EN_DUPLICATED("400","经销商英文名称不能重复"),
    DISTRIBUTOR_GRADE_CODE_DUPLICATED("400","经销商等级编码不能重复"),
    DISTRIBUTOR_GRADE_NAME_DUPLICATED("400","经销商等级中文名称不能重复"),
    DISTRIBUTOR_GRADE_NAME_EN_DUPLICATED("400","经销商等级英文名称不能重复"),
    DISTRIBUTOR_SYSTEM_CODE_DUPLICATED("400","经销商体系编码不能重复"),
    DISTRIBUTOR_SYSTEM_NAME_DUPLICATED("400","经销商体系中文名称不能重复"),
    DISTRIBUTOR_SYSTEM_NAME_EN_DUPLICATED("400","经销商体系英文名称不能重复"),
    GRADE_SYSTEM_CODE_DUPLICATED("400","体系编码不能重复"),
    GRADE_SYSTEM_NAME_DUPLICATED("400","体系名称不能重复"),
    GRADE_NAME_DUPLICATED("400","等级名称不能重复"),
    CHAIN_CHANGE_TYPE_ILLEGAL("400", "修改连琐类型非法，该连琐已在树中或者该连琐已被门店关联"),
