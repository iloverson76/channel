...
@Data
public class CommentDetailResultVO extends AbstractObject {
     ...
     * 星评评价详情
     */
    private List<CommentStarResultVO> commentStarList;
     ...
     * 回复和追评(tree)
     */
    private List<CommentDetailResultVO> replayList;
