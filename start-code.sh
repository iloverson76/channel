...
sudo mv $proj_home/xpaas-channel-center-web-provider/target/xpaas-channel-center-*.jar $proj_home/xpaas-channel-center-web-provider/target/demo.jar # 兼容所有sh脚本
