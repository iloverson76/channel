...
docker run -d --restart=on-failure:5 --privileged=true \
    ...
    java \
        ...
        -Denv=DEV \
        -Dapollo.configService=http://39.100.65.239:8080 \
        ...
        -jar /home/demo.jar \
          ...
          --eureka.client.serviceUrl.defaultZone=http://admin:deepexi@39.98.95.189:8761/eureka/ \
          --app.id=xpaas-channel-center \
          --apollo.meta=http://39.100.65.239:8080