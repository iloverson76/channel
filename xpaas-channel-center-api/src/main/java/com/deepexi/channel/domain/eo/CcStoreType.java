...
* @author admin
*/
//@ApiModel(description = "门店类型表")
public class CcStoreType{
...
// @ApiModelProperty(value = "门店类型英文名称")
    @TableField(value = "`store_type_name_en`")
...
// @ApiModelProperty(value = "租户id")
    ...
    public void setStoreTypeNameEn(String storeTypeNameEn){
    this.storeTypeNameEn = storeTypeNameEn;
    }

    public String getStoreTypeNameEn(){
    return this.storeTypeNameEn;
    }
