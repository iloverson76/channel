...
public class StoreDistributorRelationServiceImpl implements StoreDistributorRelationService {
    ...
    @Autowired
    private StoreDistributorRelationMapper storeDistributorRelationMapper;

    @Override
    public PageBean<CcStoreDistributorRelation> findPage(CcStoreDistributorRelation eo, Integer page, Integer size) {
        PageHelper.startPage(page, size);
        List<CcStoreDistributorRelation> pages =  storeDistributorRelationMapper.findList(eo);
    ...
    public List<CcStoreDistributorRelation> findAll(CcStoreDistributorRelation eo) {
        List<CcStoreDistributorRelation> list = storeDistributorRelationMapper.findList(eo);
        return list;
    }
    @Override
    public CcStoreDistributorRelation detail(Integer  pk) {
        CcStoreDistributorRelation eo = storeDistributorRelationMapper.selectById(pk);
        return eo;
    }

    @Override
    public Boolean update(Integer  id,CcStoreDistributorRelation eo) {
        CcStoreDistributorRelation old = storeDistributorRelationMapper.selectById(id);
        BeanPowerHelper.mapCompleteOverrider(eo,old); //部分更新
        int result = storeDistributorRelationMapper.updateById(old);
        if (result > 0) {
            return true;
        }
        return false;
    ...
    public Boolean create(CcStoreDistributorRelation eo) {
        int result = storeDistributorRelationMapper.insert(eo);
        if (result > 0) {
            return true;
        }
        return false;
    ...
    public Boolean delete(Integer  pk) {
        int result = storeDistributorRelationMapper.deleteBatchIds(Arrays.asList(pk));
        if (result > 0) {
            return true;
        }
        return false;
    ...
    public Boolean delete(Integer ...pks) {
        int result = storeDistributorRelationMapper.deleteBatchIds(Arrays.asList(pks));
        if (result > 0) {
            return true;
        }
        return false;
