...
import com.deepexi.channel.mapper.CcChainBankMapper;
...
@Service
public class CcChainBankServiceImpl implements CcChainBankService {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    private CcChainBankMapper ccChainBankMapper;
